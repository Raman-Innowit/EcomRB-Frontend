...
const WomensHealth = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const params = {
          health_benefit_id: 5, // Women's Health ID
          page,
          per_page: 20,
        };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'linear-gradient(90deg, rgba(248,245,237,0.95), rgba(248,245,237,0.65)), url(/assets/womens-health-bg.jpg)',
          }}
        />
        {/* Content Container */}
          ...
          <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="flex-1 mb-4 md:mb-0">
              ...
              <div className="text-sm md:text-base mb-2" style={{ color: '#000' }}>
                <Link to="/" className="hover:text-green-600 transition-colors" style={{ color: '#000' }}>HOME</Link> &gt; WOMEN'S HEALTH
              </div>
            </div>
          </div>
        </div>
          ...
          <main className="lg:w-3/4 order-2 lg:order-1">
            ...
            <div className="mb-6">
              <p className="text-gray-700 leading-relaxed mb-4" style={{ fontSize: '15px', lineHeight: '1.7' }}>
                It's a woman's right to feel her best. That's why Nutra's Bounty provides a selection of women's vitamins and supplements, which are supported by higher levels of research, knowledge, and premium ingredients. Our products support essential aspects of women's health and well-being, providing the dietary assistance required to maximise life.
              </p>
              <p className="text-gray-800 font-semibold mb-2" style={{ fontSize: '16px' }}>
                Nutra's Bounty: Always Get More!
              </p>
              <p className="text-gray-800 font-semibold mb-2" style={{ fontSize: '16px' }}>
                Supporting your journey towards a holistically healthy you
              </p>
              <p className="text-gray-700" style={{ fontSize: '15px' }}>
                – Personalised path to holistic well-being
              </p>
            </div>
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">No products found for Women's Health</p>
              </div>
            ) : (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
