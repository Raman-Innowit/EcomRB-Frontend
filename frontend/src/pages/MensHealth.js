...
const MensHealth = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const params = {
          health_benefit_id: 4, // Men's Health ID
          page,
          per_page: 20,
        };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/assets/mens-health-bg.png)',
          }}
        />
          ...
          <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="flex-1 mb-4 md:mb-0">
              ...
              <div className="text-sm md:text-base mb-2" style={{ color: '#000' }}>
                <Link to="/" className="hover:text-green-600 transition-colors" style={{ color: '#000' }}>HOME</Link> &gt; MEN'S HEALTH
              </div>
            </div>
          </div>
        </div>
          ...
          <main className="lg:w-3/4 order-2 lg:order-1">
            ...
            <div className="mb-6">
              <p className="text-gray-700 leading-relaxed mb-4" style={{ fontSize: '15px', lineHeight: '1.7' }}>
                Nutra's Bounty understands that men also have various requirements regarding well-being and living busy lives. Our men's health supplements are expertly made with premium ingredients and supported by research to meet your specific needs and support your active lifestyle. Our products are made to assist your overall wellness and strength, from boosting energy levels to improving muscular function and cardiovascular health. You can rely on Nutra's Bounty to provide dependable nutritional assistance to maximise your health and make the most of each day.
              </p>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 mt-8">
                <p className="text-gray-600 text-lg">No products found for Men's Health</p>
              </div>
            ) : (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-8">
