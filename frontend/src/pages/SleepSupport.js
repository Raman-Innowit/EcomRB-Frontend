...
const SleepSupport = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const params = {
          health_benefit_id: 2, // Sleep Support ID
          page,
          per_page: 20,
        };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/assets/sleep1.jpg)',
          }}
        />
          ...
          <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="flex-1 mb-4 md:mb-0">
              ...
              <div className="text-sm md:text-base mb-2" style={{ color: '#000' }}>
                <Link to="/" className="hover:text-green-600 transition-colors" style={{ color: '#000' }}>HOME</Link> &gt; SLEEP SUPPORT
              </div>
            </div>
          </div>
        </div>
          ...
          <main className="lg:w-3/4 order-2 lg:order-1">
            ...
            <div className="mb-6">
              <p className="text-gray-700 leading-relaxed mb-4" style={{ fontSize: '15px', lineHeight: '1.7' }}>
                Achieve a Higher Level of Sleep Support with Nutra's Bounty. Nutra's Bounty has developed a range of 100% drug-free sleep support supplements that are ideal for people who struggle with occasional insomnia or need to enhance their quality of rest. Explore our selection of science-based, innovative and high-quality sleep support supplements.
              </p>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 mt-8">
                <p className="text-gray-600 text-lg">No products found for Sleep Support</p>
              </div>
            ) : (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-8">
